...
(0, _ava2.default)('Removing Duplicates', t => {
  console.log(_problems2.default.removeDups([1, 2, 2, 3, 2, 4, 5, 3, 4, 5, 4, 3, 1, 2, 6]));
  t.is(_problems2.default.removeDups([1, 2, 2, 3, 2, 4, 5, 3, 4, 5, 4, 3, 1, 2, 6]), '[1, 2, 3, 4, 5, 6]', 'Needs to remove duplicates');
});
// test('foo', t => {
// 	t.pass();
// });
...
// 	t.is(await bar, 'bar');
// });
//# sourceMappingURL=node_modules/.cache/ava/5026b169bf3fd02876377f109785689f.js.map